...
export const Sidebar: React.FC = () => {
  ...
  return (
    <nav className="flex flex-col p-6 bg-slate-900 w-[263px] max-md:w-[200px] max-sm:p-4 max-sm:w-full">
      <img
      ...
      <button className="mt-auto flex items-center gap-2 text-xl text-red-600">
        <LogOut size={20} />
        Log Out
      </button>
    </nav>
